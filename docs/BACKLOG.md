...
- [ ] **Place gates and wire them into a live-evaluated circuit** *(wow moment — first thing built)*
...
- [ ] **Detect a win and score it by gate count**
...
- [ ] **Wire the daily puzzle end-to-end into the UI**
...
- [ ] **Gate placement and wire-connect feedback**
...
- [ ] **Synthesized SFX with a persistent mute toggle**
...
- [ ] **Design polish pass against docs/DESIGN.md**
...
- [ ] **Compute par for every daily puzzle**
...
- [ ] **Local best-score tracking per day**
